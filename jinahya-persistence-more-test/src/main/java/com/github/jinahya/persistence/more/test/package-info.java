/**
 * Abstract test classes and utilities for testing what {@link com.github.jinahya.persistence.more} defines.
 * <p>
 ...
 * {@link jakarta.persistence.AttributeConverter}: a subclass names the converter and the two types it converts between,
 * and each assertion takes an {@link com.github.jinahya.persistence.more.test.__AttributeConverterTestCase}, which
 * pairs an entity attribute with the db data it should become.
 * {@link com.github.jinahya.persistence.more.test.__StringAttributeConverter_Test} and
 * {@link com.github.jinahya.persistence.more.test.__JoinedStringAttributeConverter_Test} specialize it for the
 ...
 * constant through its converter. {@link com.github.jinahya.persistence.more.test.__AttributeEnum_TestUtils} offers the
 * same traversals, including random constant selection, to tests which do not extend those classes.
 *

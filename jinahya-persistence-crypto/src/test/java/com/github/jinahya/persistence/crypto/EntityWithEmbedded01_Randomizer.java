...
class EntityWithEmbedded01_Randomizer extends __MappedEntity_Randomizer<EntityWithEmbedded01, Long> {

    EntityWithEmbedded01_Randomizer() {
...
//              "javaSqlTimestamp1",
    ...
    @Nonnull
    @Override
    public EntityWithEmbedded01 get() {

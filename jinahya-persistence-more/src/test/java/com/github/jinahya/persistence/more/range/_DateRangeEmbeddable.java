 ...
 * link in that chain declares no access type of its own, which is why {@link __MappedRange} forces one.
 */
@Access(AccessType.FIELD)
@Embeddable
@SuppressWarnings({"java:S101"})
public class _DateRangeEmbeddable extends __MappedRange<LocalDate> {

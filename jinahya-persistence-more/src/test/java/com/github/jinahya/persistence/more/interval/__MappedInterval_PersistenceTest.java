 ...
 * supplies a point type and two samples, as in {@link __MappedTemporalInterval_Test}. What is particular to one class
...
class __MappedInterval_PersistenceTest {
     ...
     */
    abstract static class Case<E extends __MappedInterval<P>, P extends Comparable<? super P>> {
        ...
        void _twoColumns_declaredNames() {
            assertThat(columnNamesOf(tableName))
                    .contains(__MappedInterval.COLUMN_NAME_INTERVAL_START,
                              __MappedInterval.COLUMN_NAME_INTERVAL_END)
        ...
        void _notSerialized_columnType() {
            for (final var column : List.of(__MappedInterval.COLUMN_NAME_INTERVAL_START,
                                            __MappedInterval.COLUMN_NAME_INTERVAL_END)) {
    ...
    class OfYear extends Case<_YearIntervalEntity, Year> {
        ...
        void _numeric_column() {
            assertThat(columnTypeOf(_YearIntervalEntity.TABLE_NAME,
                                    __MappedInterval.COLUMN_NAME_INTERVAL_START))
    ...
    class TwoIntervalsTest {
        ...
        void _overriddenColumns_both() {
            assertThat(columnNamesOf(_BookingEntity.TABLE_NAME))
                    ...
                    .doesNotContain(__MappedInterval.COLUMN_NAME_INTERVAL_START,
                                    __MappedInterval.COLUMN_NAME_INTERVAL_END);
        }

 ...
 * <p>
 * Without the forced {@code @Access(AccessType.FIELD)} on {@link __MappedRange}, the hierarchy would flip with it
...
public class _PropertyAccessRangeEntity extends __MappedRange<LocalDate> {

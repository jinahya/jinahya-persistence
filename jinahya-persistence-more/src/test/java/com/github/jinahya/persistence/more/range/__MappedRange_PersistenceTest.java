...
import static com.github.jinahya.persistence.more.range.__BoundType.CLOSED;
import static com.github.jinahya.persistence.more.range.__BoundType.OPEN;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * Verifies {@link __MappedRange} against both persistence providers.
 * <p>
...
class __MappedRange_PersistenceTest {
    ...
    private static <T extends __MappedRange<C>, C extends Comparable<? super C>> T persist(

 ...
 * the contract on {@link __MappedRange#encode(Comparable)} in the one way monotonicity alone does not cover.
 */
@Entity
@Table(name = _PrefixUnsafeStringRangeEntity.TABLE_NAME)
@Access(AccessType.FIELD)
@SuppressWarnings({"java:S101"})
public class _PrefixUnsafeStringRangeEntity extends __MappedRange<String> {

 ...
 * about the axis. An interval of those is a {@link ___TemporalInterval} and stops there.
 *
...
public interface ___DiscreteInterval<T extends Temporal & Comparable<? super T>> extends ___TemporalInterval<T> {

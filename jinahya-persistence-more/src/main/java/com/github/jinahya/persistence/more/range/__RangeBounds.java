 ...
 * holds its own bound character — so this is derived rather than stored: {@link __Range#getRangeBounds()} pairs the
 ...
 * to exclude, and {@link __Range#getRangeBounds()} contributes {@link __BoundType#OPEN} for it — which is why a
...
public enum __RangeBounds {
     ...
     * {@link com.github.jinahya.persistence.more.interval the interval package} offers.
     */
    CLOSED_OPEN('[', ')'),

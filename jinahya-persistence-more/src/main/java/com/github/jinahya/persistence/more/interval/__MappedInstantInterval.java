 ...
 * points from {@link __Interval}. What this class settles is the point type, and with it the amount an interval of
 * instants is measured in.
 * <p>
 * It is not a {@link __DiscreteInterval}, and cannot be: an instant has no predecessor, so there is no last instant an
 ...
 * nothing standing in for it. The invariant on {@link __MappedInterval} therefore means here exactly what it reads as,
...
public abstract class __MappedInstantInterval extends __MappedTemporalInterval<Instant> {

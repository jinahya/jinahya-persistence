 ...
 * points from {@link __Interval}. {@link LocalTime#compareTo(LocalTime)} compares hour, minute, second and nanosecond
 ...
 * {@link __Interval}, read on an axis which happens to end.
 * <p>
 ...
 * to name, and writing {@code MAX} as the end would be the closed-bound substitution {@link __Interval} exists to
 ...
 * <p>
 * There is deliberately no subclass here for it. The two columns are declared in {@link __MappedInterval} and an
...
public abstract class __MappedLocalTimeInterval extends __MappedTemporalInterval<LocalTime> {

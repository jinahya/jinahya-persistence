 ...
 * here and not a property of the column — see {@link __MappedRange} for why that is worth the third fact per column.
 *
 ...
 * <p>
 * Nothing enforces it — not here, and not on {@link __MappedRange} either. A range whose lower endpoint is above
 ...
 * half-open, the interval package remains the better fit — it stores two plain typed columns, it measures, and it
 ...
 * two columns, and {@link __MappedRange} gives it.
 *
...
public interface __Range<C extends Comparable<? super C>> {
     ...
     *         none, and {@code (a,a)} is not a range at all — the invariant on {@link __MappedRange} rejects it.
     *         <p>
     ...
     *         {@link __MappedRange#encode(Comparable) the encoding} is required to agree with. An encoding which

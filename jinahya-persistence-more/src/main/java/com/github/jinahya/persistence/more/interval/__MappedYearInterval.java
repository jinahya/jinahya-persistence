 ...
 * points from {@link __Interval}. {@link Year#compareTo(Year)} compares the year values, which is the timeline at the
...
public abstract class __MappedYearInterval extends __MappedTemporalInterval<Year>
        implements __DiscreteInterval<Year> {

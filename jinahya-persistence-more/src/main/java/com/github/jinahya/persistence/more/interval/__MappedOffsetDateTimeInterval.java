 ...
 * points from {@link __Interval}. What this class settles is the point type, the amount it is measured in, and one
 ...
 * is quietly wrong. Extending {@link __MappedTemporalInterval}{@code <OffsetDateTime>} compiles, maps and reads back
...
public abstract class __MappedOffsetDateTimeInterval extends __MappedTemporalInterval<OffsetDateTime> {

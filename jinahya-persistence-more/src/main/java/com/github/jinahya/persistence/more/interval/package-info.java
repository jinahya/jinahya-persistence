 ...
 * them when asked for.
 *
 * <h2>Order is the requirement, and the only one</h2>
 * The one thing an interval has to be able to say is that its start is not after its end. That needs its two points
 * ordered and nothing else, so {@link com.github.jinahya.persistence.more.interval.__Interval} is bound by
 * {@link java.lang.Comparable} — written {@code Comparable<? super T>}, since {@link java.time.LocalDate} and its
 * siblings compare against their {@code Chrono} interfaces rather than against themselves. That requirement is documented and
 * not enforced — see {@link com.github.jinahya.persistence.more.interval.__MappedInterval} for why, and for the
 * {@code CHECK} constraint which enforces it where a schema wants that.
 *
 ...
 * <ul>
 * <li>{@code isBounded}, {@code isEmpty} and {@code contains} are on
 *     {@link com.github.jinahya.persistence.more.interval.__Interval}, because the two points and their order are all
 *     they need.
 * <li>The length is on {@link com.github.jinahya.persistence.more.interval.__TemporalInterval}, bound by
 *     {@link java.time.temporal.Temporal}, because measuring needs arithmetic and {@code Comparable} supplies none.
 *     It is the one derivation which is not a convenience: the two points are kept <em>instead</em> of an amount, so
 *     the amount has to be obtainable from them.
 * <li>{@code getGranularity} and {@code getIntervalEndInclusive} are on
 *     {@link com.github.jinahya.persistence.more.interval.__DiscreteInterval}, which a point type implements when its
 ...
 *     {@link com.github.jinahya.persistence.more.interval.__MappedInstantInterval} and its continuous siblings do not
 *     implement it.
 * </ul>
 ...
 * the database.
 * <p>
 * Two of the three defaults compare, so they are only as good as the order the point type gives.
 * {@link java.time.OffsetDateTime} is the one shipped type whose order is not the timeline, and
 * {@link com.github.jinahya.persistence.more.interval.__MappedOffsetDateTimeInterval} overrides both against instants
 ...
 * <ul>
 * <li>{@code DATE} — {@link com.github.jinahya.persistence.more.interval.__MappedLocalDateInterval}, measuring in a
 *     {@link java.time.Period}.
 * <li>{@code TIME} — {@link com.github.jinahya.persistence.more.interval.__MappedLocalTimeInterval}, measuring in a
 ...
 *     {@link com.github.jinahya.persistence.more.interval.__MappedLocalDateTimeInterval}, measuring in a
 ...
 *     {@link com.github.jinahya.persistence.more.interval.__MappedInstantInterval}, measuring in a
 ...
 *     {@link com.github.jinahya.persistence.more.interval.__MappedOffsetDateTimeInterval}, also measuring in a
 ...
 * {@link com.github.jinahya.persistence.more.interval.__MappedYearInterval} and
 * {@link com.github.jinahya.persistence.more.interval.__MappedYearMonthInterval}, each measuring in a
 ...
 * away rather than rounding it, and {@link com.github.jinahya.persistence.more.interval.__MappedLocalDateInterval} is
 ...
 * {@link com.github.jinahya.persistence.more.interval.__MappedInstantInterval} is the one to use.
 * <p>
 * {@link com.github.jinahya.persistence.more.interval.__MappedOffsetDateTimeInterval} exists for where it is not a
 ...
 * {@link com.github.jinahya.persistence.more.interval.__MappedInterval} and an entity reaches them by name, so
 ...
 * {@link com.github.jinahya.persistence.more.interval.__MappedLocalTimeInterval} works the case through.
 *
 ...
 * {@link com.github.jinahya.persistence.more.interval.__MappedInterval} and no

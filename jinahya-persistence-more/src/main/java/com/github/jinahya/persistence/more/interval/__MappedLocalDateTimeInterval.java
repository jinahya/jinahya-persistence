 ...
 * points from {@link __Interval}. {@link LocalDateTime#compareTo(java.time.chrono.ChronoLocalDateTime)} compares the
...
public abstract class __MappedLocalDateTimeInterval extends __MappedTemporalInterval<LocalDateTime> {

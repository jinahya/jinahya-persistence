 ...
 * <p>
 * A located class is expected to extend {@link __Randomizer} and to declare an accessible no-argument constructor; one
 * which does not is rejected, with a warning, by {@link __RandomizerUtils}.
 *
 * @author Jin Kwon &lt;onacit_at_gmail.com&gt;
 * @see __Randomizer
 * @see #STANDARD
 * @see __RandomizerUtils#newRandomizedInstanceOf(Class, __RandomizerLocator)
 */
@FunctionalInterface
@SuppressWarnings({
...
public interface __RandomizerLocator extends Function<Class<?>, Class<?>> {
     ...
     * <p>
     * For a target class {@code Foo}, the convention probes, in order, {@code FooRandomizer}, {@code Foo_Randomizer},

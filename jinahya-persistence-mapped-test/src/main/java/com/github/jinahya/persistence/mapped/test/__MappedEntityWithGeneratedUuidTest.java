...
public abstract class __MappedEntityWithGeneratedUuidTest<ENITTY extends __MappedEntityWithGeneratedUuid>
        extends __MappedEntityWithGeneratedIdTest<ENITTY, UUID> {

    protected __MappedEntityWithGeneratedUuidTest(final Class<ENITTY> entityClass) {

...
/**
 * Utilities for {@link __MappedEntityWithGeneratedIdentity_Randomizer}.
 *
...
public final class __MappedEntityWithGeneratedIdentity_RandomizerUtils {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    private __MappedEntityWithGeneratedIdentity_RandomizerUtils() {

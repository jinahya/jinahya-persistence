...
public abstract class __MappedEntityPersistenceH2Test<ENTITY extends __MappedEntity<ENTITY, ID>, ID>
        extends ___MappedEntityTest<ENTITY, ID> {

    // -----------------------------------------------------------------------------------------------------------------
    protected __MappedEntityPersistenceH2Test(final Class<ENTITY> entityClass, final Class<ID> idClass) {

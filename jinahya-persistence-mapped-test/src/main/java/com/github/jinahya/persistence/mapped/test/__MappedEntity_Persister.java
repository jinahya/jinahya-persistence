...
public abstract class __MappedEntity_Persister<ENTITY extends __MappedEntity<ID>, ID>
     ...
     */
    protected __MappedEntity_Persister(final Class<ENTITY> entityClass, final Class<ID> idClass) {
        super(entityClass);

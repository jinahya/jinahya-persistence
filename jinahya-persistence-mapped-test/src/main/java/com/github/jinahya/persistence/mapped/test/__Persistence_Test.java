...
public abstract class __Persistence_Test<ENTITY extends __MappedEntity<ID>, ID>
     ...
     */
    protected __Persistence_Test(final Class<ENTITY> entityClass, final Class<ID> idClass) {

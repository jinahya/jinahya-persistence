...
public abstract class __MappedEntityWithGeneratedUuidRandomizer<
        ENTITY extends __MappedEntityWithGeneratedUuid
        >
        extends __MappedEntityWithGeneratedIdRandomizer<ENTITY, UUID> {

    protected __MappedEntityWithGeneratedUuidRandomizer(@Nonnull final Class<ENTITY> entityClass,

...
/**
 * Utilities for {@link __MappedEntityWithGeneratedId_Randomizer}.
 *
...
public final class __MappedEntityWithGeneratedId_RandomizerUtils {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    private __MappedEntityWithGeneratedId_RandomizerUtils() {

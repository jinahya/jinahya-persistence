...
public abstract class __MappedEntityWithGeneratedIdPersister<
        ENTITY extends __MappedEntityWithGeneratedId<ID>,
        ID
        >
        extends __MappedEntityPersister<ENTITY, ID> {
     ...
     * @see #idClass
     */
    protected __MappedEntityWithGeneratedIdPersister(@Nonnull final Class<ENTITY> entityClass,

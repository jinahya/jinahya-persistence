...
public abstract class __MappedEntityWithGeneratedId_Instantiator<
        ENTITY extends __MappedEntityWithGeneratedId<ID>,
        ID
        >
        extends __MappedEntity_Instantiator<ENTITY, ID> {
     ...
     * @see #idClass
     */
    protected __MappedEntityWithGeneratedId_Instantiator(final Class<ENTITY> entityClass,

...
public abstract class __MappedEntityWithGeneratedUuidTest<ENTITY extends __MappedEntityWithGeneratedUuid<ENTITY>>
    ...
    // -----------------------------------------------------------------------------------------------------------------
    @Nested
    protected class ToStringTest extends __MappedEntityTest<ENTITY, UUID>.ToStringTest {
    ...
    @Nested
    protected class EqualsTest extends __MappedEntityTest<ENTITY, UUID>.EqualsTest {

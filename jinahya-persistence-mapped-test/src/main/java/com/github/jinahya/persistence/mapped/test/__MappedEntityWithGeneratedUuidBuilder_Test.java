...
public abstract class __MappedEntityWithGeneratedUuidBuilder_Test<
        BUILDER extends __MappedEntityBuilder<BUILDER, ENTITY>,
        ENTITY extends __MappedEntityWithGeneratedUuid
        >
        extends __MappedEntityWithGeneratedIdBuilder_Test<BUILDER, ENTITY, UUID> {

    // ---------------------------------------------------------------------------------------------------- CONSTRUCTORS
    protected __MappedEntityWithGeneratedUuidBuilder_Test(final Class<BUILDER> builderClass,

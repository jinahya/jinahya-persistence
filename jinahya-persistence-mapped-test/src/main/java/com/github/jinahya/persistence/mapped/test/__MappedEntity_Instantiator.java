...
public abstract class __MappedEntity_Instantiator<ENTITY extends __MappedEntity<ID>, ID>
     ...
     * @see #idClass
     */
    protected __MappedEntity_Instantiator(final Class<ENTITY> entityClass, final Class<ID> idClass) {
        super(entityClass);

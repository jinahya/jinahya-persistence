 ...
 * <dl>
 *   <dt>{@link com.github.jinahya.persistence.JinahyaEntityManagerFactoryUtils}</dt>
 *   <dd>Reads the identifier of an entity, and caches the
 *       {@link jakarta.persistence.PersistenceUnitUtil persistenceUnitUtil} and the
 *       {@link jakarta.persistence.metamodel.Metamodel metamodel} of a factory, weakly.</dd>
 *   <dt>{@link com.github.jinahya.persistence.JinahyaEntityManagerUtils}</dt>

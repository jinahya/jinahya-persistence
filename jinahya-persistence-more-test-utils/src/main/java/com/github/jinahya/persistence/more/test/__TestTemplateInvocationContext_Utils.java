...
final class __TestTemplateInvocationContext_Utils {
     ...
     *                                         {@link TestTemplateInvocationContext#getDisplayName(int) getDisplayName(int)};
     *                                         may be {@code null}.
     * @param getAdditionalExtensionsSupplier  a supplier for
     *                                         {@link TestTemplateInvocationContext#getAdditionalExtensions() getAdditionalExtensions()}.
     * @param prepareInvocationConsumer        a consumer for
     *                                         {@link TestTemplateInvocationContext#prepareInvocation(ExtensionContext) prepareInvocation(ExtensionContext)};
     *                                         may be {@code null}.
